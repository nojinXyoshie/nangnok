...
public class DataChart implements Serializable {
    ...
    private JumlahBean jumlahBean;
    @SerializedName("jumlahx")
    private JumlahxBean jumlahxBean;
    ...
    public JumlahxBean getJumlahxBean() { return jumlahxBean; }

    public void setJumlahxBean(JumlahxBean jumlahxBean) { this.jumlahxBean = jumlahxBean; }

    public static class JumlahxBean implements Serializable {

        @SerializedName("count(id_polling)") private String jumlahx;

        public String getJumlahx() {
            return jumlahx;
        }
        public void setJumlahx(String jumlahx) {
            this.jumlahx = jumlahx;
        }

    }

    public JumlahBean getJumlahBean() { return jumlahBean; }

    public void setJumlahBean(JumlahBean jumlahBean) { this.jumlahBean = jumlahBean; }

    public static class JumlahBean implements Serializable {

        @SerializedName("count(id_polling)") private String jumlah;
