...
public class JudgementTop7 extends AppCompatActivity {
    ...
    private static final String TAG = JudgementTop7.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_judgement_top7);
        ButterKnife.bind(this);

        sharedPreferences = getSharedPreferences(LoginActivity.my_shared_preferences, Context.MODE_PRIVATE);
        id_users = sharedPreferences.getString(TAG_ID, null);

        data = (DataTop7) getIntent().getSerializableExtra("data");
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!validate()) {
                    ...
                    AlertDialog.Builder alertDialoBuilder = new AlertDialog.Builder(JudgementTop7.this);
        ...
        try {
            nilaix = data.getTop7Bean().getValue();
    ...
    private void checkInput(final String nilaix) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_top7, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(JudgementTop7.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(JudgementTop7.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_top7, new Response.Listener<String>() {
