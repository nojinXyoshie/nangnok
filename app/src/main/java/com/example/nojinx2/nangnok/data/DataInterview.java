...
public class DataInterview implements Serializable {
    ...
    public InterviewBean getInterviewBean() { return interviewBean; }

    public void setInterviewBean(InterviewBean interviewBean) { this.interviewBean = interviewBean; }
