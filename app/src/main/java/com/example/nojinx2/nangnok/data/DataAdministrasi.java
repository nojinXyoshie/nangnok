...
public class DataAdministrasi implements Serializable {
    ...
    private AdministrasiBean administrasiBean;
    ...
    public AdministrasiBean getAdministrasiBean() { return administrasiBean; }

    public void setAdministrasiBean(AdministrasiBean administrasiBean) { this.administrasiBean = administrasiBean; }

    public static class AdministrasiBean implements Serializable {
