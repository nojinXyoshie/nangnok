...
public class DataPresentasi implements Serializable {
    ...
    @SerializedName("presentasi")
    private PresentasiBean presentasiBean;
    ...
    public PresentasiBean getPresentasiBean() { return presentasiBean; }

    public void setPresentasiBean(PresentasiBean presentasiBean) { this.presentasiBean = presentasiBean; }

    public static class PresentasiBean implements Serializable {
