...
public class BasingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_basing, container, false);
        ...
        try {
            interviewx = data.getWawancaraBean().getPariwisataBean().getInterviewBasingBean().getValue();
            groomingx = data.getWawancaraBean().getPariwisataBean().getGroomingBasingBean().getValue();
            mannerx = data.getWawancaraBean().getPariwisataBean().getMannerBasingBean().getValue();

            notex = data.getWawancaraBean().getPariwisataBean().getCatatanBasingBean().getNote();
            kategorix = data.getWawancaraBean().getPariwisataBean().getCatatanBasingBean().getStatus();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (interviewx == null){
            ...
            interview.setText(data.getWawancaraBean().getPariwisataBean().getInterviewBasingBean().getValue());
        ...
        if (groomingx == null){
            ...
            grooming.setText(data.getWawancaraBean().getPariwisataBean().getGroomingBasingBean().getValue());
        ...
        if (mannerx == null){
            ...
            manner.setText(data.getWawancaraBean().getPariwisataBean().getMannerBasingBean().getValue());
    ...
    private void checkInput(final String interviewx, final String groomingx, final String mannerx) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_basing, new Response.Listener<String>() {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_basing, new Response.Listener<String>() {
