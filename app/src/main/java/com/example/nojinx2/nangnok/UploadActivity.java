...
import static com.example.nojinx2.nangnok.LoginActivity.TAG_USERNAME;
    ...
    private void uploadImage() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                //kosong();
                                finish();
                                Intent intent = new Intent(UploadActivity.this, UploadActivity2.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                data.put(KEY_IMAGE, getStringImage(decoded).trim());
                data.put(KEY_INFORMATION, txt_information.getText().toString().trim());
                data.put(KEY_ID, txt_id.getText().toString().trim());
                data.put(KEY_NAMA, txt_nama.getText().toString().trim());
