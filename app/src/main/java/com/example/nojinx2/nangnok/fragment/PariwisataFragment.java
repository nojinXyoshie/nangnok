...
public class PariwisataFragment extends Fragment {
    ...
    private static final String TAG = PariwisataFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            interviewx = data.getWawancaraBean().getPariwisataBean().getInterviewPariwisataBean().getValue();
            groomingx = data.getWawancaraBean().getPariwisataBean().getGroomingPariwisataBean().getValue();
            mannerx = data.getWawancaraBean().getPariwisataBean().getMannerPariwisataBean().getValue();

            notex = data.getWawancaraBean().getPariwisataBean().getCatatanPariwisataBean().getNote();
            kategorix = data.getWawancaraBean().getPariwisataBean().getCatatanPariwisataBean().getStatus();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (interviewx == null){
            ...
            interview.setText(data.getWawancaraBean().getPariwisataBean().getInterviewPariwisataBean().getValue());
        ...
        if (groomingx == null){
            ...
            grooming.setText(data.getWawancaraBean().getPariwisataBean().getGroomingPariwisataBean().getValue());
        ...
        if (mannerx == null){
            ...
            manner.setText(data.getWawancaraBean().getPariwisataBean().getMannerPariwisataBean().getValue());
    ...
    private void checkInput(final String interviewx, final String groomingx, final String mannerx) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_pariwisata, new Response.Listener<String>() {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_pariwisata, new Response.Listener<String>() {
