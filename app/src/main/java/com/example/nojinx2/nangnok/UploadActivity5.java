...
public class UploadActivity5 extends AppCompatActivity {
    ...
    private String UPLOAD_URL = Server.URL + "upload5.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(UploadActivity5.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();

                                //kosong();
                                finish();
                                Intent intent = new Intent(UploadActivity5.this, UploadActivity6.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(UploadActivity5.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
