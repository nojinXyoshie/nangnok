...
public class KesenianFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            interviewx = data.getWawancaraBean().getPariwisataBean().getInterviewKesenianBean().getValue();
            groomingx = data.getWawancaraBean().getPariwisataBean().getGroomingKesenianBean().getValue();
            mannerx = data.getWawancaraBean().getPariwisataBean().getMannerKesenianBean().getValue();

            notex = data.getWawancaraBean().getPariwisataBean().getCatatanKesenianBean().getNote();
            kategorix = data.getWawancaraBean().getPariwisataBean().getCatatanKesenianBean().getStatus();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (interviewx == null){
            ...
            interview.setText(data.getWawancaraBean().getPariwisataBean().getInterviewKesenianBean().getValue());
        ...
        if (groomingx == null){
            ...
            grooming.setText(data.getWawancaraBean().getPariwisataBean().getGroomingKesenianBean().getValue());
        ...
        if (mannerx == null){
            ...
            manner.setText(data.getWawancaraBean().getPariwisataBean().getMannerKesenianBean().getValue());
    ...
    private void checkInput(final String interviewx, final String groomingx, final String mannerx) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_kesenian, new Response.Listener<String>() {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_kesenian, new Response.Listener<String>() {
