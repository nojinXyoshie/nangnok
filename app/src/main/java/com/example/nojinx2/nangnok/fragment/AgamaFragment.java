...
public class AgamaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_agama, container, false);
        ...
        try {
            interviewx = data.getWawancaraBean().getPariwisataBean().getInterviewAgamaBean().getValue();
            groomingx = data.getWawancaraBean().getPariwisataBean().getGroomingAgamaBean().getValue();
            mannerx = data.getWawancaraBean().getPariwisataBean().getMannerAgamaBean().getValue();

            notex = data.getWawancaraBean().getPariwisataBean().getCatatanAgamaBean().getNote();
            kategorix = data.getWawancaraBean().getPariwisataBean().getCatatanAgamaBean().getStatus();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (interviewx == null){
            ...
            interview.setText(data.getWawancaraBean().getPariwisataBean().getInterviewAgamaBean().getValue());
        ...
        if (groomingx == null){
            ...
            grooming.setText(data.getWawancaraBean().getPariwisataBean().getGroomingAgamaBean().getValue());
        ...
        if (mannerx == null){
            ...
            manner.setText(data.getWawancaraBean().getPariwisataBean().getMannerAgamaBean().getValue());
    ...
    private void checkInput(final String interviewx, final String groomingx, final String mannerx) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_agama, new Response.Listener<String>() {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_agama, new Response.Listener<String>() {
