...
public class UploadActivity2 extends AppCompatActivity {
    ...
    private String UPLOAD_URL = Server.URL + "upload2.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(UploadActivity2.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(UploadActivity2.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
