...
public class DataKabisa implements Serializable {
    ...
    @SerializedName("kabisa")
    private KabisaBean kabisaBean;
    ...
    public KabisaBean getKabisaBean() { return kabisaBean; }

    public void setKabisaBean(KabisaBean kabisaBean) { this.kabisaBean = kabisaBean; }

    public static class KabisaBean implements Serializable {
