...
public class DataTop7 implements Serializable {
    ...
    public Top7Bean getTop7Bean() { return top7Bean; }

    public void setTop7Bean(Top7Bean top7Bean) { this.top7Bean = top7Bean; }

    public static class Top7Bean implements Serializable {
