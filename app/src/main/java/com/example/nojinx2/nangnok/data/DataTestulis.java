...
public class DataTestulis implements Serializable {
    ...
    @SerializedName("testulis")
    private TestulisBean testulisBean;
    ...
    public TestulisBean getTestulisBean() { return testulisBean; }

    public void setTestulisBean(TestulisBean testulisBean) { this.testulisBean = testulisBean; }

    public static class TestulisBean implements Serializable {
