...
public class JudgementAdministrasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_judgement_administrasi);
        ButterKnife.bind(this);

        sharedPreferences = getSharedPreferences(LoginActivity.my_shared_preferences, Context.MODE_PRIVATE);
        id_users = sharedPreferences.getString(TAG_ID, null);

        data = (DataAdministrasi) getIntent().getSerializableExtra("data");
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!validate()) {
                    ...
                    AlertDialog.Builder alertDialoBuilder = new AlertDialog.Builder(JudgementAdministrasi.this);
        ...
        try {
            nilaix = data.getAdministrasiBean().getValue();
    ...
    private void checkInput(final String nilaix) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_nilai_administrasi, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(JudgementAdministrasi.this,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(JudgementAdministrasi.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
    ...
    private void checkInput_note(final String notex, final String kategori) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, Server.input_note_administrasi, new Response.Listener<String>() {
